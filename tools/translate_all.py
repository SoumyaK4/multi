...
posts_dir = '../_posts/'
source_lang = "English"
target_langs = ["Korean", "Japanese", "Traditional Chinese (Taiwan)","Spanish", "Brazilian Portuguese", "French", "German", "Czech", "Slovenian"]
source_lang_code = "ko"
target_lang_codes = ["ko", "ja", "zh-TW", "es", "pt-BR", "fr", "de", "cs-CZ", "sl-SI"]
